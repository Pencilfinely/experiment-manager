...
本说明适用于 **0.3.0-rc.2 桌面预览版**。日常操作从 Experiment Center 和 Experiment Worker 进入；旧版终端入口保留作兼容和诊断用途。
...
**0.3.0-rc.1 及更早版本没有“检查更新”入口。**先手动下载安装 0.3.0-rc.2 一次，之后 Windows 版本即可使用上面的应用内流程。Ubuntu 算力端继续下载新版包并使用已有脚本。手动升级 Windows 也适用以下步骤：
